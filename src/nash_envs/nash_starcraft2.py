...
from nash_envs.nash_smac_maps import get_map_params
import atexit
...
"""
Generally, this is to modify the SMAC env to make that the two teams can both be trained
Then, we make that the the second team can be either 'Bot' or 'Agent'

"""


class NashStarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.enemies_type = enemies_type  # setting whether the second player is 'bot' or 'agent'
